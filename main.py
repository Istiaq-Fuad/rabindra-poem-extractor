...
def main():
    ...
    # if all_poems:
    #     print(f"Scrape completed! Found {len(all_poems)} poems in total.")
    #     scraper.save_poems(all_poems, "output/rabindra_poems.json")
    #     scraper.save_poems_text(all_poems, "output/rabindra_poems.txt")
    # else:
